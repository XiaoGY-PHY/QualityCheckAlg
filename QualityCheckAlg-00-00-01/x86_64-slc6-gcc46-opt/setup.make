...
use ParticleID ParticleID-00-04-68 Analysis (/cvmfs/bes3.ihep.ac.cn/bes3sw/Boss/7.0.6.a)
...
xiaogy_no_config (from PROJECT) excludes [xiaogy_config]
xiaogy_root (from PROJECT) excludes [xiaogy_no_root]
xiaogy_cleanup (from PROJECT) excludes [xiaogy_no_cleanup]
xiaogy_scripts (from PROJECT) excludes [xiaogy_no_scripts]
xiaogy_prototypes (from PROJECT) excludes [xiaogy_no_prototypes]
xiaogy_with_installarea (from PROJECT) excludes [xiaogy_without_installarea]
xiaogy_with_version_directory (from PROJECT) excludes [xiaogy_without_version_directory]
xiaogy (from PROJECT)
...
----------> CMTPATH
# Add path /workfs2/bes/xiaogy/Boss706a from initialization
