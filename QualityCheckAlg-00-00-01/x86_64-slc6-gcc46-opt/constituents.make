...
#cmt_local_tagfile = $(QualityCheckAlg_tag).make
cmt_local_tagfile = $(bin)$(QualityCheckAlg_tag).make
...
cmt_local_setup_QualityCheckAlg = $(bin)setup_QualityCheckAlg$$$$.make
...
QualityCheckAlg_extratags = -tag_add=target_QualityCheckAlg

#$(cmt_local_tagfile_QualityCheckAlg) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_QualityCheckAlg) ::
else
$(cmt_local_tagfile_QualityCheckAlg) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_QualityCheckAlg); then /bin/rm -f $(cmt_local_tagfile_QualityCheckAlg); fi ; \
	  $(cmtexe) -tag=$(tags) $(QualityCheckAlg_extratags) build tag_makefile >>$(cmt_local_tagfile_QualityCheckAlg)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_QualityCheckAlg)"; \
	  test ! -f $(cmt_local_setup_QualityCheckAlg) || \rm -f $(cmt_local_setup_QualityCheckAlg); \
	  trap '\rm -f $(cmt_local_setup_QualityCheckAlg)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(QualityCheckAlg_extratags) show setup >$(cmt_local_setup_QualityCheckAlg) && \
	  if [ -f $(cmt_final_setup_QualityCheckAlg) ] && \
	    \cmp -s $(cmt_final_setup_QualityCheckAlg) $(cmt_local_setup_QualityCheckAlg); then \
	    \rm $(cmt_local_setup_QualityCheckAlg); else \
	    \mv -f $(cmt_local_setup_QualityCheckAlg) $(cmt_final_setup_QualityCheckAlg); fi
...
not_QualityCheckAlg_dependencies = { n=0; for p in $?; do m=0; for d in $(QualityCheckAlg_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
QualityCheckAlgdirs :
	@if test ! -d $(bin)QualityCheckAlg; then $(mkdir) -p $(bin)QualityCheckAlg; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)QualityCheckAlg
else
QualityCheckAlgdirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)QualityCheckAlg
#
#$(cmt_local_QualityCheckAlg_makefile) :: $(QualityCheckAlg_dependencies) $(cmt_local_tagfile_QualityCheckAlg) build_library_links dirs QualityCheckAlgdirs
#else
#$(cmt_local_QualityCheckAlg_makefile) :: $(QualityCheckAlg_dependencies) $(cmt_local_tagfile_QualityCheckAlg) build_library_links dirs
#endif
#else
#$(cmt_local_QualityCheckAlg_makefile) :: $(cmt_local_tagfile_QualityCheckAlg)
#endif

ifdef cmt_QualityCheckAlg_has_target_tag

ifndef QUICK
$(cmt_local_QualityCheckAlg_makefile) : $(QualityCheckAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building QualityCheckAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(QualityCheckAlg_extratags) build constituent_config -out=$(cmt_local_QualityCheckAlg_makefile) QualityCheckAlg
else
$(cmt_local_QualityCheckAlg_makefile) : $(QualityCheckAlg_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_QualityCheckAlg) ] || \
	  [ ! -f $(cmt_final_setup_QualityCheckAlg) ] || \
	  $(not_QualityCheckAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building QualityCheckAlg.make"; \
	  $(cmtexe) -tag=$(tags) $(QualityCheckAlg_extratags) build constituent_config -out=$(cmt_local_QualityCheckAlg_makefile) QualityCheckAlg; \
	  fi
endif
...
$(cmt_local_QualityCheckAlg_makefile) : $(QualityCheckAlg_dependencies) build_library_links
	$(echo) "(constituents.make) Building QualityCheckAlg.make"; \
	  $(cmtexe) -f=$(bin)QualityCheckAlg.in -tag=$(tags) $(QualityCheckAlg_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_QualityCheckAlg_makefile) QualityCheckAlg
else
$(cmt_local_QualityCheckAlg_makefile) : $(QualityCheckAlg_dependencies) $(cmt_build_library_linksstamp) $(bin)QualityCheckAlg.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_QualityCheckAlg) ] || \
	  [ ! -f $(cmt_final_setup_QualityCheckAlg) ] || \
	  $(not_QualityCheckAlg_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(QualityCheckAlg_extratags) build constituent_makefile -out=$(cmt_local_QualityCheckAlg_makefile) QualityCheckAlg

QualityCheckAlg :: $(QualityCheckAlg_dependencies) $(cmt_local_QualityCheckAlg_makefile) dirs QualityCheckAlgdirs
	$(echo) "(constituents.make) Starting QualityCheckAlg"
	@if test -f $(cmt_local_QualityCheckAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_QualityCheckAlg_makefile) QualityCheckAlg; \
	  fi
#	@$(MAKE) -f $(cmt_local_QualityCheckAlg_makefile) QualityCheckAlg
	$(echo) "(constituents.make) QualityCheckAlg done"

clean :: QualityCheckAlgclean

QualityCheckAlgclean :: $(QualityCheckAlgclean_dependencies) ##$(cmt_local_QualityCheckAlg_makefile)
	$(echo) "(constituents.make) Starting QualityCheckAlgclean"
	@-if test -f $(cmt_local_QualityCheckAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_QualityCheckAlg_makefile) QualityCheckAlgclean; \
	fi
	$(echo) "(constituents.make) QualityCheckAlgclean done"
#	@-$(MAKE) -f $(cmt_local_QualityCheckAlg_makefile) QualityCheckAlgclean

##	  /bin/rm -f $(cmt_local_QualityCheckAlg_makefile) $(bin)QualityCheckAlg_dependencies.make

install :: QualityCheckAlginstall

QualityCheckAlginstall :: $(QualityCheckAlg_dependencies) $(cmt_local_QualityCheckAlg_makefile)
	$(echo) "(constituents.make) Starting install QualityCheckAlg"
	@-$(MAKE) -f $(cmt_local_QualityCheckAlg_makefile) install
	$(echo) "(constituents.make) install QualityCheckAlg done"

uninstall : QualityCheckAlguninstall

$(foreach d,$(QualityCheckAlg_dependencies),$(eval $(d)uninstall_dependencies += QualityCheckAlguninstall))

QualityCheckAlguninstall : $(QualityCheckAlguninstall_dependencies) ##$(cmt_local_QualityCheckAlg_makefile)
	$(echo) "(constituents.make) Starting uninstall QualityCheckAlg"
	@if test -f $(cmt_local_QualityCheckAlg_makefile); then \
	  $(MAKE) -f $(cmt_local_QualityCheckAlg_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_QualityCheckAlg_makefile) uninstall
	$(echo) "(constituents.make) uninstall QualityCheckAlg done"

remove_library_links :: QualityCheckAlguninstall
...
#cmt_local_tagfile_config = $(QualityCheckAlg_tag)_config.make
cmt_local_tagfile_config = $(bin)$(QualityCheckAlg_tag)_config.make
cmt_local_setup_config = $(bin)setup_config$$$$.make
cmt_final_setup_config = $(bin)setup_config.make
#cmt_final_setup_config = $(bin)QualityCheckAlg_configsetup.make
...
#cmt_local_tagfile_config = $(QualityCheckAlg_tag).make
cmt_local_tagfile_config = $(bin)$(QualityCheckAlg_tag).make
cmt_final_setup_config = $(bin)setup.make
#cmt_final_setup_config = $(bin)QualityCheckAlgsetup.make
cmt_local_config_makefile = $(bin)config.make
...
#cmt_local_tagfile_install_includes = $(QualityCheckAlg_tag)_install_includes.make
cmt_local_tagfile_install_includes = $(bin)$(QualityCheckAlg_tag)_install_includes.make
...
#cmt_final_setup_install_includes = $(bin)QualityCheckAlg_install_includessetup.make
...
#cmt_local_tagfile_install_includes = $(QualityCheckAlg_tag).make
cmt_local_tagfile_install_includes = $(bin)$(QualityCheckAlg_tag).make
cmt_final_setup_install_includes = $(bin)setup.make
#cmt_final_setup_install_includes = $(bin)QualityCheckAlgsetup.make
cmt_local_install_includes_makefile = $(bin)install_includes.make
...
#cmt_local_tagfile_make = $(QualityCheckAlg_tag)_make.make
cmt_local_tagfile_make = $(bin)$(QualityCheckAlg_tag)_make.make
cmt_local_setup_make = $(bin)setup_make$$$$.make
cmt_final_setup_make = $(bin)setup_make.make
#cmt_final_setup_make = $(bin)QualityCheckAlg_makesetup.make
...
#cmt_local_tagfile_make = $(QualityCheckAlg_tag).make
cmt_local_tagfile_make = $(bin)$(QualityCheckAlg_tag).make
cmt_final_setup_make = $(bin)setup.make
#cmt_final_setup_make = $(bin)QualityCheckAlgsetup.make
cmt_local_make_makefile = $(bin)make.make
...
#cmt_local_tagfile_CompilePython = $(QualityCheckAlg_tag)_CompilePython.make
cmt_local_tagfile_CompilePython = $(bin)$(QualityCheckAlg_tag)_CompilePython.make
cmt_local_setup_CompilePython = $(bin)setup_CompilePython$$$$.make
cmt_final_setup_CompilePython = $(bin)setup_CompilePython.make
#cmt_final_setup_CompilePython = $(bin)QualityCheckAlg_CompilePythonsetup.make
...
#cmt_local_tagfile_CompilePython = $(QualityCheckAlg_tag).make
cmt_local_tagfile_CompilePython = $(bin)$(QualityCheckAlg_tag).make
cmt_final_setup_CompilePython = $(bin)setup.make
#cmt_final_setup_CompilePython = $(bin)QualityCheckAlgsetup.make
cmt_local_CompilePython_makefile = $(bin)CompilePython.make
...
#cmt_local_tagfile_qmtest_run = $(QualityCheckAlg_tag)_qmtest_run.make
cmt_local_tagfile_qmtest_run = $(bin)$(QualityCheckAlg_tag)_qmtest_run.make
cmt_local_setup_qmtest_run = $(bin)setup_qmtest_run$$$$.make
cmt_final_setup_qmtest_run = $(bin)setup_qmtest_run.make
#cmt_final_setup_qmtest_run = $(bin)QualityCheckAlg_qmtest_runsetup.make
...
#cmt_local_tagfile_qmtest_run = $(QualityCheckAlg_tag).make
cmt_local_tagfile_qmtest_run = $(bin)$(QualityCheckAlg_tag).make
cmt_final_setup_qmtest_run = $(bin)setup.make
#cmt_final_setup_qmtest_run = $(bin)QualityCheckAlgsetup.make
cmt_local_qmtest_run_makefile = $(bin)qmtest_run.make
...
#cmt_local_tagfile_qmtest_summarize = $(QualityCheckAlg_tag)_qmtest_summarize.make
cmt_local_tagfile_qmtest_summarize = $(bin)$(QualityCheckAlg_tag)_qmtest_summarize.make
...
#cmt_final_setup_qmtest_summarize = $(bin)QualityCheckAlg_qmtest_summarizesetup.make
...
#cmt_local_tagfile_qmtest_summarize = $(QualityCheckAlg_tag).make
cmt_local_tagfile_qmtest_summarize = $(bin)$(QualityCheckAlg_tag).make
cmt_final_setup_qmtest_summarize = $(bin)setup.make
#cmt_final_setup_qmtest_summarize = $(bin)QualityCheckAlgsetup.make
cmt_local_qmtest_summarize_makefile = $(bin)qmtest_summarize.make
...
#cmt_local_tagfile_TestPackage = $(QualityCheckAlg_tag)_TestPackage.make
cmt_local_tagfile_TestPackage = $(bin)$(QualityCheckAlg_tag)_TestPackage.make
cmt_local_setup_TestPackage = $(bin)setup_TestPackage$$$$.make
cmt_final_setup_TestPackage = $(bin)setup_TestPackage.make
#cmt_final_setup_TestPackage = $(bin)QualityCheckAlg_TestPackagesetup.make
...
#cmt_local_tagfile_TestPackage = $(QualityCheckAlg_tag).make
cmt_local_tagfile_TestPackage = $(bin)$(QualityCheckAlg_tag).make
cmt_final_setup_TestPackage = $(bin)setup.make
#cmt_final_setup_TestPackage = $(bin)QualityCheckAlgsetup.make
cmt_local_TestPackage_makefile = $(bin)TestPackage.make
...
#cmt_local_tagfile_TestProject = $(QualityCheckAlg_tag)_TestProject.make
cmt_local_tagfile_TestProject = $(bin)$(QualityCheckAlg_tag)_TestProject.make
cmt_local_setup_TestProject = $(bin)setup_TestProject$$$$.make
cmt_final_setup_TestProject = $(bin)setup_TestProject.make
#cmt_final_setup_TestProject = $(bin)QualityCheckAlg_TestProjectsetup.make
...
#cmt_local_tagfile_TestProject = $(QualityCheckAlg_tag).make
cmt_local_tagfile_TestProject = $(bin)$(QualityCheckAlg_tag).make
cmt_final_setup_TestProject = $(bin)setup.make
#cmt_final_setup_TestProject = $(bin)QualityCheckAlgsetup.make
cmt_local_TestProject_makefile = $(bin)TestProject.make
...
#cmt_local_tagfile_new_rootsys = $(QualityCheckAlg_tag)_new_rootsys.make
cmt_local_tagfile_new_rootsys = $(bin)$(QualityCheckAlg_tag)_new_rootsys.make
cmt_local_setup_new_rootsys = $(bin)setup_new_rootsys$$$$.make
cmt_final_setup_new_rootsys = $(bin)setup_new_rootsys.make
#cmt_final_setup_new_rootsys = $(bin)QualityCheckAlg_new_rootsyssetup.make
...
#cmt_local_tagfile_new_rootsys = $(QualityCheckAlg_tag).make
cmt_local_tagfile_new_rootsys = $(bin)$(QualityCheckAlg_tag).make
cmt_final_setup_new_rootsys = $(bin)setup.make
#cmt_final_setup_new_rootsys = $(bin)QualityCheckAlgsetup.make
cmt_local_new_rootsys_makefile = $(bin)new_rootsys.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(QualityCheckAlg_tag)_DatabaseSvc_check_install_scripts.make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(QualityCheckAlg_tag)_DatabaseSvc_check_install_scripts.make
...
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)QualityCheckAlg_DatabaseSvc_check_install_scriptssetup.make
...
#cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(QualityCheckAlg_tag).make
cmt_local_tagfile_DatabaseSvc_check_install_scripts = $(bin)$(QualityCheckAlg_tag).make
cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)setup.make
#cmt_final_setup_DatabaseSvc_check_install_scripts = $(bin)QualityCheckAlgsetup.make
cmt_local_DatabaseSvc_check_install_scripts_makefile = $(bin)DatabaseSvc_check_install_scripts.make
...
cmt_local_setup_QualityCheckAlg_check_install_runtime = $(bin)setup_QualityCheckAlg_check_install_runtime$$$$.make
...
QualityCheckAlg_check_install_runtime_extratags = -tag_add=target_QualityCheckAlg_check_install_runtime

#$(cmt_local_tagfile_QualityCheckAlg_check_install_runtime) : $(cmt_lock_setup)
ifndef QUICK
$(cmt_local_tagfile_QualityCheckAlg_check_install_runtime) ::
else
$(cmt_local_tagfile_QualityCheckAlg_check_install_runtime) :
endif
	$(echo) "(constituents.make) Rebuilding $@"; \
	  if test -f $(cmt_local_tagfile_QualityCheckAlg_check_install_runtime); then /bin/rm -f $(cmt_local_tagfile_QualityCheckAlg_check_install_runtime); fi ; \
	  $(cmtexe) -tag=$(tags) $(QualityCheckAlg_check_install_runtime_extratags) build tag_makefile >>$(cmt_local_tagfile_QualityCheckAlg_check_install_runtime)
	$(echo) "(constituents.make) Rebuilding $(cmt_final_setup_QualityCheckAlg_check_install_runtime)"; \
	  test ! -f $(cmt_local_setup_QualityCheckAlg_check_install_runtime) || \rm -f $(cmt_local_setup_QualityCheckAlg_check_install_runtime); \
	  trap '\rm -f $(cmt_local_setup_QualityCheckAlg_check_install_runtime)' 0 1 2 15; \
	  $(cmtexe) -tag=$(tags) $(QualityCheckAlg_check_install_runtime_extratags) show setup >$(cmt_local_setup_QualityCheckAlg_check_install_runtime) && \
	  if [ -f $(cmt_final_setup_QualityCheckAlg_check_install_runtime) ] && \
	    \cmp -s $(cmt_final_setup_QualityCheckAlg_check_install_runtime) $(cmt_local_setup_QualityCheckAlg_check_install_runtime); then \
	    \rm $(cmt_local_setup_QualityCheckAlg_check_install_runtime); else \
	    \mv -f $(cmt_local_setup_QualityCheckAlg_check_install_runtime) $(cmt_final_setup_QualityCheckAlg_check_install_runtime); fi
...
not_QualityCheckAlg_check_install_runtime_dependencies = { n=0; for p in $?; do m=0; for d in $(QualityCheckAlg_check_install_runtime_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
QualityCheckAlg_check_install_runtimedirs :
	@if test ! -d $(bin)QualityCheckAlg_check_install_runtime; then $(mkdir) -p $(bin)QualityCheckAlg_check_install_runtime; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)QualityCheckAlg_check_install_runtime
else
QualityCheckAlg_check_install_runtimedirs : ;
endif
...
#	$(echo) "STRUCTURED_OUTPUT="$(bin)QualityCheckAlg_check_install_runtime
#
#$(cmt_local_QualityCheckAlg_check_install_runtime_makefile) :: $(QualityCheckAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_QualityCheckAlg_check_install_runtime) build_library_links dirs QualityCheckAlg_check_install_runtimedirs
#else
#$(cmt_local_QualityCheckAlg_check_install_runtime_makefile) :: $(QualityCheckAlg_check_install_runtime_dependencies) $(cmt_local_tagfile_QualityCheckAlg_check_install_runtime) build_library_links dirs
#endif
#else
#$(cmt_local_QualityCheckAlg_check_install_runtime_makefile) :: $(cmt_local_tagfile_QualityCheckAlg_check_install_runtime)
#endif

ifdef cmt_QualityCheckAlg_check_install_runtime_has_target_tag

ifndef QUICK
$(cmt_local_QualityCheckAlg_check_install_runtime_makefile) : $(QualityCheckAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building QualityCheckAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(QualityCheckAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_QualityCheckAlg_check_install_runtime_makefile) QualityCheckAlg_check_install_runtime
else
$(cmt_local_QualityCheckAlg_check_install_runtime_makefile) : $(QualityCheckAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_QualityCheckAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_QualityCheckAlg_check_install_runtime) ] || \
	  $(not_QualityCheckAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building QualityCheckAlg_check_install_runtime.make"; \
	  $(cmtexe) -tag=$(tags) $(QualityCheckAlg_check_install_runtime_extratags) build constituent_config -out=$(cmt_local_QualityCheckAlg_check_install_runtime_makefile) QualityCheckAlg_check_install_runtime; \
	  fi
endif
...
$(cmt_local_QualityCheckAlg_check_install_runtime_makefile) : $(QualityCheckAlg_check_install_runtime_dependencies) build_library_links
	$(echo) "(constituents.make) Building QualityCheckAlg_check_install_runtime.make"; \
	  $(cmtexe) -f=$(bin)QualityCheckAlg_check_install_runtime.in -tag=$(tags) $(QualityCheckAlg_check_install_runtime_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_QualityCheckAlg_check_install_runtime_makefile) QualityCheckAlg_check_install_runtime
else
$(cmt_local_QualityCheckAlg_check_install_runtime_makefile) : $(QualityCheckAlg_check_install_runtime_dependencies) $(cmt_build_library_linksstamp) $(bin)QualityCheckAlg_check_install_runtime.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_QualityCheckAlg_check_install_runtime) ] || \
	  [ ! -f $(cmt_final_setup_QualityCheckAlg_check_install_runtime) ] || \
	  $(not_QualityCheckAlg_check_install_runtime_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(QualityCheckAlg_check_install_runtime_extratags) build constituent_makefile -out=$(cmt_local_QualityCheckAlg_check_install_runtime_makefile) QualityCheckAlg_check_install_runtime

QualityCheckAlg_check_install_runtime :: $(QualityCheckAlg_check_install_runtime_dependencies) $(cmt_local_QualityCheckAlg_check_install_runtime_makefile) dirs QualityCheckAlg_check_install_runtimedirs
	$(echo) "(constituents.make) Starting QualityCheckAlg_check_install_runtime"
	@if test -f $(cmt_local_QualityCheckAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_QualityCheckAlg_check_install_runtime_makefile) QualityCheckAlg_check_install_runtime; \
	  fi
#	@$(MAKE) -f $(cmt_local_QualityCheckAlg_check_install_runtime_makefile) QualityCheckAlg_check_install_runtime
	$(echo) "(constituents.make) QualityCheckAlg_check_install_runtime done"

clean :: QualityCheckAlg_check_install_runtimeclean

QualityCheckAlg_check_install_runtimeclean :: $(QualityCheckAlg_check_install_runtimeclean_dependencies) ##$(cmt_local_QualityCheckAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting QualityCheckAlg_check_install_runtimeclean"
	@-if test -f $(cmt_local_QualityCheckAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_QualityCheckAlg_check_install_runtime_makefile) QualityCheckAlg_check_install_runtimeclean; \
	fi
	$(echo) "(constituents.make) QualityCheckAlg_check_install_runtimeclean done"
#	@-$(MAKE) -f $(cmt_local_QualityCheckAlg_check_install_runtime_makefile) QualityCheckAlg_check_install_runtimeclean

##	  /bin/rm -f $(cmt_local_QualityCheckAlg_check_install_runtime_makefile) $(bin)QualityCheckAlg_check_install_runtime_dependencies.make

install :: QualityCheckAlg_check_install_runtimeinstall

QualityCheckAlg_check_install_runtimeinstall :: $(QualityCheckAlg_check_install_runtime_dependencies) $(cmt_local_QualityCheckAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting install QualityCheckAlg_check_install_runtime"
	@-$(MAKE) -f $(cmt_local_QualityCheckAlg_check_install_runtime_makefile) install
	$(echo) "(constituents.make) install QualityCheckAlg_check_install_runtime done"

uninstall : QualityCheckAlg_check_install_runtimeuninstall

$(foreach d,$(QualityCheckAlg_check_install_runtime_dependencies),$(eval $(d)uninstall_dependencies += QualityCheckAlg_check_install_runtimeuninstall))

QualityCheckAlg_check_install_runtimeuninstall : $(QualityCheckAlg_check_install_runtimeuninstall_dependencies) ##$(cmt_local_QualityCheckAlg_check_install_runtime_makefile)
	$(echo) "(constituents.make) Starting uninstall QualityCheckAlg_check_install_runtime"
	@if test -f $(cmt_local_QualityCheckAlg_check_install_runtime_makefile); then \
	  $(MAKE) -f $(cmt_local_QualityCheckAlg_check_install_runtime_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_QualityCheckAlg_check_install_runtime_makefile) uninstall
	$(echo) "(constituents.make) uninstall QualityCheckAlg_check_install_runtime done"

remove_library_links :: QualityCheckAlg_check_install_runtimeuninstall
